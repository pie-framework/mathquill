...
LatexCmds.ngtr = LatexCmds['≯'] = bind(BiggerSymbolStyle('mq-ngtr', '&#8815;'), '\\ngtr ', 'span', 'class="mq-non-leaf mq-ngtr"');
LatexCmds.nless = LatexCmds['≮'] = bind(BiggerSymbolStyle('mq-nless', '&#8814;'), '\\nless ', 'span', 'class="mq-non-leaf mq-nless"');
...
var SupSub = P(MathCommand, function(_, super_) {
  ...
  _.latex = function() {
    function latex(prefix, block) {
      ...
      // console.log('_latex in SupSub', block ? prefix + '{' + (l || ' ') + '}' : '');
...
var Matrix = LatexCmds.matrix = P(MathCommand, function(_, super_) {
